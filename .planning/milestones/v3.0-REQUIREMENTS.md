...
## v3.1 Requirements (Merged into v3.0 milestone)

### Coverage -- 翻译覆盖率提升

- [x] **COV-01**: 翻译条目数 >= 2,500（最终 2,657 条）
- [x] **COV-02**: 总体翻译覆盖率 >= 80%（最终 99.3%）
- [x] **COV-03**: 用户高频可见字符串覆盖率 >= 95%（最终 100.0%）
...
---
*Requirements merged from v3.1 into v3.0 milestone (2026-04-08)*
